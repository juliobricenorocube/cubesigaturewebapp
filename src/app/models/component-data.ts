...
export class ComponentChart {
  ...
  chartType: string;
  chartDatasets: Array<ChartDatasets> = new Array<ChartDatasets>();
  chartLabels: Array<string> = new Array<string>();
  chartColors: Array<ChartColors> = new Array<ChartColors>();
  chartOptions: any;
}
